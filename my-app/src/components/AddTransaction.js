...
function AddTransaction() {
    ...
    const [allTransactions, setAllTransactions] = useState(JSON.parse(sessionStorage.getItem('transactions')) || []);
    ...
    const handleSubmit = (e) => {
        ...
        const newTransaction = { category: categoryValue.current.value, amount: amountValue.current.value };
