...
import { Button, ButtonGroup, Container, Image, CardGroup, Modal, Form} from "react-bootstrap";
      ...
      <div style={{ display: "flex", marginTop: "2rem" }}>
        ...
        >
          ...
          <Card className="deposit-money" border="dark border-2">
            ...
            <Card.Body className="card-body-1">
            <Button className="deposit-button" variant="light" onClick={handleModalOpen}>
              Deposit Money
            </Button>
          </Card.Body>
            ...
            <Modal.Body>
              <Form>
                <Form.Group className="form-group">
                  ...
                  <Form.Control type="text" className="form-control" ref={amount}/>
                </Form.Group>
              </Form>
            </Modal.Body>
            <Modal.Footer>
              <Button variant="secondary" onClick={handleModalClose} style={{ marginRight: '10px' }}>
                Close
              </Button>
