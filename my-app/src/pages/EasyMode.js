        ...
        <div>
            ...
            <div style={{display:'flex', marginTop:'2rem'}}>
                ...
                <Card className='card-left'>
                    <Card.Header as="h2" className='card-headers'>Checking Account</Card.Header>
                ...
                <div className='button-div'>
                    <Button className='button'><Image src={arrow} alt='right-arrow' style={{width:'100%', backgroundColor:'white'}}/></Button>
                    <div></div>
                    <Button className='button'><Image src={arrow} alt='right-arrow' style={{width:'100%', backgroundColor:'white', transform:'scaleX(-1)'}}/></Button>
                </div>


                <Card className='card-right'>
                    <Card.Header as="h2" className='card-headers'>Savings Account</Card.Header>
                    <Card.Body className='card-body-1'>
                ...
                <Container style={{width:'25%', marginRight:'6%'}}>
                    <Card className='credit-card'>
                        <div>
                            <Card.Header as="h2" className='card-headers'>Credit Card</Card.Header>
                            <Card.Body className='card-body-1'>
                    ...
                    <Card className='send-money'>
                        <Card.Header as="h2" className='card-headers'>Send/Receive Money</Card.Header>
                    ...
                    <Card className='deposit-money'>
                        <Card.Header as='h2' className='card-headers'>Deposit Money</Card.Header>
                        <Card.Body className='card-body-1'>
